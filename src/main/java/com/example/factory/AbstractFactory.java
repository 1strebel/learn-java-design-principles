...
class HotDrinkMachine
{
    ...
    private List<Map.Entry<String, IHotDrinkFactory>> namedFactories =
            new ArrayList<>();
    ...
    public HotDrinkMachine() throws Exception
    {
        ...
        for (AvailableDrink drink : AvailableDrink.values())
        {
            ...
            Class<?> factory = Class.forName("com.example.factory." + factoryName + "Factory");
        ...
        Set<Class<? extends IHotDrinkFactory>> types =
                new Reflections("com.example.factory") // ""
                        .getSubTypesOf(IHotDrinkFactory.class);
        for (Class<? extends IHotDrinkFactory> type : types)
        {
            namedFactories.add(new AbstractMap.SimpleEntry<String, IHotDrinkFactory>(
    ...
    public IHotDrink makeDrink() throws IOException
    {
        ...
        {
            Map.Entry<String, IHotDrinkFactory> item = namedFactories.get(index);
