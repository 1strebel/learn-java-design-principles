...
class Person1 extends Observable<Person1> {
    private int age;
...
class ObserverInfrastructureDemo implements Observer<Person1>
        // Observer<Foo>
{
    ...
    @Override
    public void handle(PropertyChangedEventArgs<Person1> args) {
